...
- dependency injection into **any** abstract methods without parameters, called _synapse methods_
- synapse methods can be members of **any** class or interface, called a _neuron class_ or _neuron interface_
