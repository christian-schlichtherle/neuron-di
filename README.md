...
When combining Neuron DI with other DI frameworks, programmers can increase the power and flexibility of their DI of 
choice with lazy dependency resolution, caching and dependency injection into Java interfaces or Scala traits.
