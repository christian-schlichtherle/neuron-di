  ...
  "An overridable methods collector" should {
    "collect overridable methods" in {
      ...
      methods shouldBe Set(
        ...
        "protected abstract java.lang.String global.namespace.neuron.di.java.sample.bar.Bar.bar()",
        "protected abstract java.lang.String global.namespace.neuron.di.java.sample.foo.Foo.foo()",
