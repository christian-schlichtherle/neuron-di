...
import global.tranquillity.neuron.di.spi.InspectionSpec._
import global.tranquillity.neuron.di.spi.it.{AnotherInterface, AnotherNeuronClass, SomeNeuronClass, SomeNeuronInterface}
